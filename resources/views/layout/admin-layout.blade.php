...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="nav flex-column">
            ...
            <a href="{{ route('adddepart') }}" class="nav-link" onclick="showSection('departments')">
                <i class="fa-solid fa-building"></i> Departments
            </a>
            <a href="{{ route('doctor') }}" class="nav-link" onclick="showSection('doctors')">
            ...
            <a href="check-appointment" class="nav-link" onclick="showSection('appointments')">
                <i class="fa-solid fa-calendar-check"></i> Appointments
            </a>



            <a href="logout" class="nav-link text-danger" onclick="logout()">
    ...
    <script>
        ...
        Livewire.on('editdoctor', () =>{
            let modal = document.getElementById('editdoct');
            var msg = new bootstrap.Modal(modal);
            msg.show();
